...
btn.addEventListener('click', e => {
    ...
    showResult.children[0].classList = '';
    showResult.children[1].classList = '';
    if(formIsValid && passwordIsValid && passwordMatched){
        ...
        showResult.children[1].classList.add('hidden');
        showResult.classList.add('bg-green-200');
        showResult.classList.remove('bg-red-200')
      ...
      showResult.classList.remove('hidden');
      showResult.children[0].classList.add('hidden');
      showResult.classList.remove('bg-green-200');
      showResult.classList.add('bg-red-200')
    }
})
